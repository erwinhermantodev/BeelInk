...
export default function EditProductForm({ product }: EditProductFormProps) {
  ...
  const [stockQty, setStockQty] = useState(product.stockQty === -1 ? '0' : String(product.stockQty));
  const [unit, setUnit] = useState(product.unit);
  const [isUnlimited, setIsUnlimited] = useState(product.stockQty === -1);
    ...
    <main className="min-h-screen py-10 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-black uppercase tracking-tight text-ink mt-4">Edit Product</h1>
          <p className="text-sm font-bold text-gray-700 uppercase tracking-wider mt-1">
            Update product details or manage stock
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <button
                ...
                className="w-full brutalist-btn-cyan py-4 text-md tracking-wide"
              >
              ...
              <button
                ...
                disabled={loading || deleting}
                className="w-full bg-red-400 hover:bg-red-500 text-ink border-3 border-ink font-black uppercase text-md tracking-wide py-4 shadow-[4px_4px_0px_0px_rgba(65,36,2,1)] active:translate-x-1 active:translate-y-1 active:shadow-[1px_1px_0px_0px_rgba(65,36,2,1)] transition-all cursor-pointer"
              >
